    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('In Working', 'В разработке'), ('In planeted', 'Запланирован'), ('Freeze', 'Заморожен'), ('Ready', 'Завершен')], max_length=35)),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('avatar', models.ImageField(default='media/avatar.png', upload_to='')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', models.TextField()),
                ('status', models.CharField(choices=[('Active', 'Активен'), ('Archived', 'Архивирован')], max_length=35)),
                ('priority', models.CharField(choices=[('Low', 'Низкий'), ('Medium', 'Средний'), ('High', 'Высокий')], max_length=40)),
                ('created_at', models.DateField(auto_now_add=True)),
                ('updated_at', models.DateField(auto_now_add=True)),
